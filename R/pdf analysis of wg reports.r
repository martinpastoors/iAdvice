# Search through WG documents - UNFINISHED / NOT WORKING
...
for (wg in c("HAWG")) {
    ...
    print(list.files(
      path    = "D:/ZZZ",
      pattern = paste("^",wg," [0-9]{4}.pdf", sep="")) )
}

# loop over years
for (wg in c("HAWG")) {
  assign(paste("results",wg,sep=""), {
    print(wg)
    keyword_directory("D:/zzz",
                      ...
                      file_pattern   = paste("^",wg," [0-9]{4}.pdf", sep=""),
